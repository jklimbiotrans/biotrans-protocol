...
- 벌점 부여는 비활성화 또는 강하게 제한.  
- 상점 기록은 기본 **비공개**, 원하면 공개 가능.

### 3.2 유효 조건
- **다수 공명 조건** – 여러 명이 같은 시점에 공감·인정해야 유효.  
- **공명 다양성** – 동일 집단·성향만의 인증은 무효, 다양한 배경 필요.  
- **시간 가중치·복리 구조** – 장기·반복적 선행은 더 큰 보상.  
- **반복성** – 같은 선행이 지속되면 신뢰도 상승.  
- **신뢰도 반영** – 감화력이 높은 사람의 부여는 가중치 상승.  
- **회심 보상** – 과거 점수가 낮았던 사람이 변화 시 추가 보상.
